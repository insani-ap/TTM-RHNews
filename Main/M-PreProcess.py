...
def process_data(file_path, output_file):
    ...
    # Membaca file CSV
    file_path = os.path.join("Dataset", "Mafindo", "Mafindo.csv")
    ...
    pd.Series(veryClean).to_csv(output_file)

    print("\nPreprocessing completed!")

# Path file input dan output
file = os.path.join("Dataset", "Mafindo", "Mafindo.csv")
output_file = "MafindoCleaned.csv"
