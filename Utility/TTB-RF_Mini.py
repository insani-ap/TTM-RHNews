...
param_combinations = [
    (100, None, 2, 1, "sqrt", True, True, "gini", 0.0, -1, 50),
...
for n_est, max_d, min_split, min_leaf, max_feat, boot, oob, crit, min_impurity, jobs, rand_state in param_combinations:
    try:
        ...
        print(f"Error with params: {n_est}, {max_d}, {min_split}, {min_leaf}, {max_feat}, {boot}, {oob}, {crit}, {min_impurity}, {jobs}, {rand_state}: {e}")
